<?php
    ...
    // These should ideally be worked out in your controllers and passed to your view ;)
    $logged = $_SESSION['auth_logged_in'] ?? false;
    $temp_email = $_SESSION['temp_email'] ?? false;
    $admin = isset($_SESSION['auth_roles']) && $_SESSION['auth_roles'] === 1;
    $username = $_SESSION['auth_username'] ?? 'Wonderful Person';
    // See how I cleaned all that up?
...
<body>
    ...
    <!-- Include the page -->
    <?php
    // This might be a good thing to extract into a separate function ;)
...
<!-- Why aren't we using our BASEURL define here? -->
